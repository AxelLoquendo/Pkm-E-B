...
const u32 gPartyMenuBgFemale_Gfx[] = INCBIN_U32("graphics/party_menu/bgFemale.4bpp.smol");
const u16 gPartyMenuBgFemale_Pal[] = INCBIN_U16("graphics/party_menu/bgFemale.gbapal");
