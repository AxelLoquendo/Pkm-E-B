...
const u8 gText_PkmnShroudedInMist[] = _("¡Neblina ha cubierto a {B_ATK_TEAM1}!");
const u8 gText_PkmnGettingPumped[] = _("¡{B_DEF_NAME_WITH_PREFIX} se está preparando para luchar!");
...
const u8 gText_DefendersStatRose[] = _("¡{B_BUFF1} de {B_DEF_NAME_WITH_PREFIX} subió{B_BUFF2}!");
...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNMOVEWASDISABLED]                  = COMPOUND_STRING("¡{B_BUFF1} de {B_DEF_NAME_WITH_PREFIX} fue desactivado por Anulación!"),
    ...
    [STRINGID_ATTACKERSSTATROSE]                    = COMPOUND_STRING("¡{B_BUFF1} de {B_ATK_NAME_WITH_PREFIX} {B_BUFF2}aumentó!"),
    [STRINGID_DEFENDERSSTATROSE]                    = gText_DefendersStatRose,
    [STRINGID_ATTACKERSSTATFELL]                    = COMPOUND_STRING("{B_BUFF1} de {B_ATK_NAME_WITH_PREFIX} {B_BUFF2}bajó."),
    [STRINGID_DEFENDERSSTATFELL]                    = COMPOUND_STRING("{B_BUFF1} de {B_DEF_NAME_WITH_PREFIX} {B_BUFF2}bajó."),
    ...
    [STRINGID_ATTACKERABILITYSTATRAISE]             = COMPOUND_STRING("¡{B_SCR_ABILITY} de {B_ATK_NAME_WITH_PREFIX} ha aumentado su {B_BUFF1}!"),
