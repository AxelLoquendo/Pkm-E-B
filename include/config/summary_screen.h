...
#define P_SUMMARY_SCREEN_IV_EV_TILESET   TRUE  // Si está habilitado, cargará un tileset alternativo para permitir cambiar la etiqueta "Estadísticas" en la página de habilidades en la pantalla de sumario. Nota: puede ser que requiera un make clean.
