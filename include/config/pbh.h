#ifndef GUARD_CONFIG_PBH_H
#define GUARD_CONFIG_PBH_H

//Mecánicas configurables exclusivas del PBH.
#define PBH_PALETAS_UNICAS                  FALSE    // Si está habilitado, los sprites de los Pokémon (tanto los de batalla como en el OW) tendrán una variación (no demasiado grande, pero visible) según su personalidad. Créditos a CitrusBolt.
#define PBH_INTENSIDAD_VARIACION_PALETAS    0      // Grado de variación de sistema de las paletas únicas de los Pokémon. Va de 0 a 100, siendo 0 sin variación y 10 variación completa.
